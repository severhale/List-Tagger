...
YL = np.asarray(YL)
YT = np.asarray(YT)
treeclf = RandomForestClassifier(n_estimators=27, criterion='entropy', max_features='auto', bootstrap=True, oob_score=True, n_jobs=2, class_weight="balanced", random_state=42)
